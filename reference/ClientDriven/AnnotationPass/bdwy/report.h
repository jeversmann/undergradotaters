...
public:
  ...
  string const getString() {return _literal;}
...
public:
  ...
  inline bool isError() const {return _is_error;}
  inline const exprAnn* getCondition() const {return _condition;}
  inline const report_element_list& getElementsList() const {return _elements;}
