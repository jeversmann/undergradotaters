...
public:
  ...
  // TB
  /** @brief get the Annotations */
  inline Annotations *annotations() { return _annotations; }
...
private:
  ...
  /* begin TB new */
  void cs_pass_one_external_output(procedureInfo * callee,
                                   procedureInfo * caller,
                                   stmtLocation * current_callsite,
                                   memoryBlock * block_to_pass,
                                   bool is_return_value);
  friend class Adaptor_Statistics;
};
