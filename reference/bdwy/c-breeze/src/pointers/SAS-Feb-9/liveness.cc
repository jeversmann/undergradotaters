...
void livenessAnalyzer::at_call(stmtLocation * current, callNode * call,
...
Node * deadcodeChanger::at_exprstmt(exprstmtNode * the_exprstmt, Order ord)
{
  ...
  if (the_exprstmt->expr())
    ...
    if (_liveness->isLive(the_exprstmt))
      return the_exprstmt;
    else {
