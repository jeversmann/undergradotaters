...
if.else:                                          ; preds = %if.end
  ...
  %arrayidx5 = getelementptr inbounds i32, i32* %0, i64 1
...
for.cond:                                         ; preds = %for.inc, %if.end6
  %resp.1 = phi i32 [ 1, %if.end6 ], [ %4, %for.inc ]
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx9 = getelementptr inbounds i32, i32* %0, i64 %idxprom
  ...
  %arrayidx15 = getelementptr inbounds i32, i32* %0, i64 %idxprom14
...
if.end:                                           ; preds = %entry
  ...
  %arrayidx7 = getelementptr inbounds i32, i32* %0, i64 3
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx11 = getelementptr inbounds i32, i32* %0, i64 %idxprom
  %1 = load i32, i32* %arrayidx11, align 4
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %1)
  br label %for.inc
